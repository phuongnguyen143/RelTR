...
# This is a help function to calculate iou
# we don't know "side effects" of some prewritten methods here so better be safe
...
def compute_iou(box1, box2):
    ...
    Parameters:
    box1: A list of 4 elements [x1, y1, x2, y2] representing the first bounding box.
    box2: A list of 4 elements [x1, y1, x2, y2] representing the second bounding box.
